...
<body>
    ...
    <div class="complet_profile_container">
        ...
        <div class="complet_profile_form_container">
            ...
            <form action="./php/PhotographerCompletProfile.php" method="POST" enctype="multipart/form-data">
                <p>Complet Profile</p>
                ...
                <input class="complet_profile_input" type="text" placeholder="Bank Name" name="bankname" required />
                <input class="complet_profile_input" type="text" placeholder="Bank Acount Number" name="bankno" required />
                <textarea placeholder="description" rows="4" class="complet_profile_input" name="description"  ></textarea>
